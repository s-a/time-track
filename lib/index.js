...
var Tracker = function(program) {
	...
	if (!program.switch){
		...
		if ((program.validate && program.validate !== true) || (program.report && program.report !== true)){
			var d;
			if (program.validate){
				d = new TimeTrackDateValue(program.validate);
		...
		//this.todayDateString = timeTrackDateValue.toString();
