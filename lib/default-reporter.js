...
Reporter.prototype.compute = function() {
	...
	if(this.timeTracker.program.timerange && this.timeTracker.program.timerange !== true){
		this.timeTracker.openConfiguration(new TimeTrackDateValue(this.timeTracker.program.timerange));
	}
